...
<head>
  ...
  <title>Change Customer Profile Picture</title>
...
<body>
  <div class="d-flex justify-content-center align-items-center" style="height: 100vh; background-color: black">
    <div style=" 
      ...
      padding: 20px 10px;
    color: white;">
      <form action="{{route('updateCustomerImage')}}" method="post" enctype="multipart/form-data">
        {{csrf_field()}}
        ...
        <a class="btn btn-sm btn-danger mt-3 px-4"  style="margin-left:190px" href="{{ route('customerDashboard') }}">Back</a>  
      </form>
    </div>
  </div>
</body>
