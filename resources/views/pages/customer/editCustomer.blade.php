                ...
                ">
                    ...
                    <form action="{{route('updateCustomer')}}" method="post">
                        ...
                        <table class="mb-4">
                            <tr>
                                <td>
                                    <h4 class="fw-bold mt-5">Update {{ $customers->name }}'s Information</h4>
                                </td>
                        ...
                        <table>
                            <tr hidden>
                                <td>Id</td>
                                <td> <input type="text" name="id" value={{ $customers->id }}></td>
                            </tr>
                            <tr>
                                <td><label class="pr-3">Name</label></td>
                                <td class="pr-3 py-2" style="width:400px;"><input type="text" value={{ $customers->name }}
                            ...
                            <tr hidden>
                                ...
                                <td class="pr-3 py-2"><select type="input" value={{ $customers->role }} name="role"
                                        class="form-control">
                            ...
                            <tr >
                                ...
                                <td class="pr-3 py-2"><input value={{ $customers->email }} type="text" name="email"
                                        class="form-control">
                                </td>
                                <td>
                                    <div>
                            ...
                            <tr>
                                ...
                                <td class="pr-3 py-2"><input style="width:400px;" value={{ $customers->address }} type="text" name="address"
                            ...
                            <tr>
                                ...
                                <td class="pr-3 py-2"><input value={{ $customers->phone }} type="text" name="phone"
                                        class="form-control">
                                </td>
                                <td>
                                    <div>
                            ...
                            <tr>
                                ...
                                <td class="pr-3 py-2"><input value={{ $customers->password }} type="password"
                            ...
                            <tr>
                                ...
                                <td class="pr-3 py-2"><select value={{ $customers->status }} name="status"
                                        class="form-control">
