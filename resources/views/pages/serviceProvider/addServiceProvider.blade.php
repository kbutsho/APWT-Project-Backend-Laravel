        ...
        <div>
            <div class="form-area">
                ...
                ">
                    ...
                    <form action="{{route('addServiceProvider')}}" method="post">
                        {{csrf_field()}}

                        <table  class="mb-4">
                            <tr>
                                <td>
                                    <h4 class="fw-bold">Add Service Provider</h4>
                                </td>
                                <td> 
                                    @if(session('serviceProvider-added'))
                                    <div class="text-center text-white" style="width: 100%; padding: 10px 10px; margin-left: 20px; border-radius: 10px; background-color: #C32BAD">
                                        <span class="fw-bold">{{ session('serviceProvider-added') }}</span>
                                    </div>
                                    @endif
                                    </td>
                            </tr>
